...
interface DependencyInjection {
  storageLib?: { setItem : (key: string, value: string) => void, getItem: (key: string) => void}
}

export default class Storage extends Module {

  constructor(core : Core, private config : Config | null, private dependencyInjection: DependencyInjection | null) {
    super(core);
